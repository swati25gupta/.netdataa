...
namespace SampleConApp
{
    class ArraysDemo
    {
        ...
        private static void clonevsCopy()
        {
            string[] fruits = { "Apple", "Mango", "Orange" };
            Array copy = (string[])fruits.Clone();//replicate the data.... 

            string[] data = new string[10];
            fruits.CopyTo(data, 5);//From the 5th position in the destination, it will copy all the elements of the source to the destination
